...
const Modal = () => {
  ...
  useEffect(() => {
    if (memberDetail) {
      setNama(memberDetail.name || "");
      setUmur(memberDetail.umur || "");
      setBootcamp(memberDetail.bootcamp || "");
      setDivisi(memberDetail.divisi || "");
      setMakanan(memberDetail.makanan || "");
    }
  }, [memberDetail]);
  ...
  const handleSubmit = (e) => {
    ...
    updateMember(id, data, (status, res) => {
      if (status) {
